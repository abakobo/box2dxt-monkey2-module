...
Class Box2DgfxTest Extends Window
	...
	Field myCollisionCallback:=New CollisionCallback ()
	...
	'------- Initialising the world with its gravity
		...
		world=mx2b2dJson.Loadb2dJson("asset::fixturebalance2.json")
...
'		mx2b2dJson.testNew()
	...
	Method OnRender( canvas:Canvas ) Override
		...
		canvas.DrawText("grab objects with you mouse to activate collision (printed in console).",15,15)
...
Class CollisionCallback Extends b2ContactListener
	...
	Method EndContact (contact:b2Contact) Override
		Print "End Contact"
		Local pos:=contact.GetFixtureA().GetBody().GetPosition()
		Print pos
	End	
